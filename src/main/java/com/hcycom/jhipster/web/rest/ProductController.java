...
public class ProductController {
	...
	@Timed
	@PreAuthorize("@InterfacePermissions.hasPermission(authentication, 'productmodule/api/product')")
	...
	@Timed
	@PreAuthorize("@InterfacePermissions.hasPermission(authentication, 'productmodule/api/product_deleteByMore')")
	...
	@Timed
	@PreAuthorize("@InterfacePermissions.hasPermission(authentication, 'productmodule/api/product_put')")
	...
	@Timed
	@PreAuthorize("@InterfacePermissions.hasPermission(authentication, 'productmodule/api/product_get/{uuid}')")
	...
	@Timed
	@PreAuthorize("@InterfacePermissions.hasPermission(authentication, 'productmodule/api/product_getAll')")
